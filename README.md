...
### 5. Google Drive API 認証情報の配置（オプション）
...
- [複数事件管理](MULTI_CASE_GUIDE.md) - 複数事件の並行管理
- [途中再開と一括処理](RESUME_AND_BATCH_GUIDE.md) - バッチ処理ガイド
- [Google Drive連携](GOOGLE_DRIVE_GUIDE.md) - Google Drive設定方法
- [事件選択機能](CASE_SELECTOR_GUIDE.md) - 事件選択の使い方
...
# Google Drive フォルダID
CASE_FOLDER_ID = "your_folder_id_here"
KO_EVIDENCE_FOLDER_ID = "your_evidence_folder_id_here"
...
問題が発生した場合:
1. [USAGE_GUIDE.md](USAGE_GUIDE.md) を確認
